...
/*     if (ChartBundleLayers) {
    ...
    europe.push(createGeoJsonLayer('PL AWACS Orbits', 'plawacsorbits', 'geojson/europe/PL_Mil_AWACS_Orbits.geojson', 'rgba(252, 186, 3, 0.3)', 'rgba(252, 186, 3, 1)', false));
    ...
    europe.push(createGeoJsonLayer('NL AWACS Orbits', 'nlawacsorbits', 'geojson/europe/NL_Mil_AWACS_Orbits.geojson', 'rgba(252, 186, 3, 0.3)', 'rgba(252, 186, 3, 1)', false));

    // Taken from https://github.com/olithissen/AwacsOrbitsDE
    europe.push(createGeoJsonLayer('DE AWACS Orbits', 'deawacsorbits', 'geojson/europe/DE_Mil_AWACS_Orbits.geojson', 'rgba(252, 186, 3, 0.3)', 'rgba(252, 186, 3, 1)', false));

    // Taken from https://github.com/alkissack/Dump1090-OpenLayers3-html
    uk.push(createGeoJsonLayer('Military Airfields', 'ukmilaf', 'geojson/uk_mil/UK_Mil_Airfield_runways_named.geojson', 'rgba(192, 0, 0, 1)', 'rgba(128, 0, 0, 0.5)'));
    uk.push(createGeoJsonLayer('MATZ', 'ukmatz', 'geojson/uk_mil/UK_MATZ_2024.geojson', 'rgba(0, 0, 255, 0.05)', 'rgba(128, 0, 0, 0.5)', false));
    uk.push(createGeoJsonLayer('Radar Corridors', 'ukradarcorridors', 'geojson/uk_mil/UK_Mil_RC.geojson', 'rgba(125, 0, 0, 0.1)', 'rgba(125, 0, 0, 0)'));
    uk.push(createGeoJsonLayer('AWACS Orbits', 'ukawacsorbits', 'geojson/uk_mil/UK_Mil_AWACS_Orbits.geojson', 'rgba(0, 255, 0, 0.05)', 'rgba(0, 255, 0, 0.5)', false));
    uk.push(createGeoJsonLayer('Danger Areas', 'dareas', 'geojson/uk_mil/UK_Danger_Areas.geojson', 'rgba(255, 0, 0, 0.05)', 'rgba(255, 0, 0, 0.5)'));
    uk.push(createGeoJsonLayer('A2A Refueling', 'uka2arefueling', 'geojson/uk_mil/UK_Mil_AAR_Zones.geojson', 'rgba(52, 50, 168, 0.1)', 'rgba(52, 50, 168, 0.1)'));
    uk.push(createGeoJsonLayer('CIVI', 'ukcivi', 'geojson/uk_misc/UK_Civi_Airports_named.geojson', 'rgba(0, 0, 255, 0.05)', 'rgba(128, 0, 0, 0.5)'));
    uk.push(createGeoJsonLayer('ATZ', 'ukatz', 'geojson/uk_misc/UK_ATZONE.geojson', 'rgba(0, 0, 255, 0.05)', 'rgba(128, 0, 0, 0.5)', false));
    uk.push(createGeoJsonLayer('Airways', 'ukairways', 'geojson/uk_misc/UK_Airways.geojson', 'rgba(0, 125, 0, 0.1)', 'rgba(0, 125, 0, 0)'));
    uk.push(createGeoJsonLayer('Airspace', 'ukaspace', 'geojson/uk_misc/UK_AIRSPACE.geojson', 'rgba(0, 0, 255, 0.04)', 'rgba(128, 0, 0, 0.1)'));
    uk.push(createGeoJsonLayer('Nav Points', 'uknvpt', 'geojson/uk_misc/UK_NavigationPoints.geojson', 'rgba(255, 0, 0, 0.05)', 'rgba(255, 0, 0, 0.5)'));

    us.push(createGeoJsonLayer('US A2A Refueling', 'usa2arefueling', 'geojson/us/US_A2A_refueling.geojson', 'rgba(52, 50, 168, 0.3)', 'rgba(52, 50, 168, 1)'));
    us.push(createGeoJsonLayer('US ARTCC Boundaries', 'usartccboundaries', 'geojson/us/US_ARTCC_boundaries.geojson', 'rgba(255, 0, 255, 0.3)', 'rgba(255, 0, 255, 1)', false));

    if (uk_advisory) {
        uk.push(createGeoJsonLayer('uka_airports', 'uka_airports', 'geojson/uk_advisory/airports.geojson', 'rgba(255, 255, 255, 1)', 'rgba(255, 255, 255, 1)'));
        uk.push(createGeoJsonLayer('uka_airspaces', 'uka_airspaces', 'geojson/uk_advisory/airspaces.geojson', 'rgba(0, 0, 0, 0.1)', 'rgba(0, 30, 255, 0.2)'));
        uk.push(createGeoJsonLayer('hotspots', 'hotspots', 'geojson/uk_advisory/hotspots.geojson', 'rgba(255, 255, 255, 1)', 'rgba(255, 255, 255, 1)'));
        uk.push(createGeoJsonLayer('navaids', 'navaids', 'geojson/uk_advisory/navaids.geojson', 'rgba(0, 0, 0, 1)', 'rgba(0, 0, 0, 1)'));
        uk.push(createGeoJsonLayer('uka_runways', 'uka_runways', 'geojson/uk_advisory/runways.geojson', 'rgba(0, 0, 0, 0.5)', 'rgba(0, 0, 0, 0.5)'));
        uk.push(createGeoJsonLayer('uka_shoreham', 'uka_shoreham', 'geojson/uk_advisory/shoreham.geojson', 'rgba(0, 0, 0, 0.5)', 'rgba(0, 0, 0, 0.5)'));
    }
    ...
    if (uk.getLength() > 0) {
        layers.push(new ol.layer.Group({
            name: 'uk',
            title: 'UK',
            layers: new ol.Collection(uk.getArray().reverse()),
            fold: 'open',
        }));
    }
